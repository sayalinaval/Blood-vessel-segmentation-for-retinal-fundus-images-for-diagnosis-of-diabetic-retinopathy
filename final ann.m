...
for i=1:17
    for j=1:17
        sc22(i,j)=((i-ib)^1)*((j-jb)^1)*subn(i,j);
    end
end
...
for i=1:17
    for j=1:17
        sc11(i,j)=((i-ib)^0)*((j-jb)^0)*subn(i,j);
    end
end
...
for i=1:17
    for j=1:17
        sc13(i,j)=((i-ib)^0)*((j-jb)^2)*subn(i,j);
    end
end
...
for i=1:17
    for j=1:17
        sc31(i,j)=((i-ib)^2)*((j-jb)^0)*subn(i,j);
    end
end
